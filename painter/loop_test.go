...
type Mock struct {
	mock.Mock // Vanya added 3 structures: MockReceiver, MockScreen, MockTexture, but thay had same structure, so I used just Mock.
} // duplicating code is the evil, Oleg!!
...
// I tried to add understandable names =) реально пытался.
